...
/**
 * Special TabHost that allows the use of {@link Fragment} objects for its tab content. When placing this in a view hierarchy, after inflating the hierarchy you must call
 ...
 * <p>
 * This can also be used inside of a fragment through fragment nesting: {@sample development/samples/Support4Demos/src/com/example/android/supportv4/app/FragmentTabsFragmentSupport.java complete}
 */
public class MyFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    private void ensureContent(){
        if (mRealTabContent == null) {
            ...
            if (mRealTabContent == null) { throw new IllegalStateException ("No tab content FrameLayout found for id " + mContainerId); }
        }
    }
    ...
    private FragmentTransaction doTabChanged(String tabId,FragmentTransaction ft){
        ...
        if (newTab == null) { throw new IllegalStateException ("No tab known for tag " + tabId); }
        if (mLastTab != newTab) {
            if (ft == null) {
                ft = mFragmentManager.beginTransaction ();
            }
