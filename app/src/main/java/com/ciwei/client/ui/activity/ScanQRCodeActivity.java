...
import com.ciwei.client.zxing.camera.CameraManager;
import com.ciwei.client.zxing.decoding.CaptureActivityHandler;
import com.ciwei.client.zxing.decoding.InactivityTimer;
import com.ciwei.client.zxing.view.ViewfinderView;
...
public class ScanQRCodeActivity extends BaseActivity implements Callback {
    ...
    protected int getLayoutResource() {
        return R.layout.activity_qrcode_caputure;
    }
...
//            this.setResult(RESULT_OK, resultIntent);
            LogUtil.i(TAG,"---------987777777777777777777777777---"+resultString);
        }
