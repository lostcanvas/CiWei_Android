...
import com.ciwei.client.view.LockPatternView;
 ...
 */
public class CreateGesturePasswordActivity extends ActionBarActivity implements View.OnClickListener{
    ...
    private void saveChosenPatternAndFinish() {
        GlobalApp.getInstance().getLockPatternUtils().saveLockPattern(mChosenPattern);
        showToast("密码设置成功");
